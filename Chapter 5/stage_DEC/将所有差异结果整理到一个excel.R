...
##将小鼠相邻阶段差异表达的circRNA整合到一个excel的不同sheet中

setwd("E:/工作电脑D盘/科研文档/UCD/Thesis/Qiaowei_PhD_Thesis_Supporting/Chapter 5/stage_DEC")
...
for (file in files) {
  ...
  sheet_name <- gsub("^20250703all_decirc_", "", sheet_name)   # 去掉开头的20250407
